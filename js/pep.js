...
(function (global, factory) {
  ...
  var dispatcher = {
    ...
    setCapture(inPointerId, inTarget) {
  ...
  Installer.prototype = {
    ...
    elementChanged(el, oldValue) {
      this.changedCallback(el, oldValue);
    },
    concatLists(accum, list) {
  ...
  var mouseEvents = {
    ...
    prepareButtonsForMove(e, inEvent) {
  ...
  var touchEvents = {
    ...
    touchActionToScrollType(touchAction) {
      var t = touchAction;
    ...
    POINTER_TYPE: 'touch',
    firstTouch: null,
    isPrimaryTouch(inTouch) {
      return this.firstTouch === inTouch.identifier;
    },
    setPrimaryTouch(inTouch) {
    ...
    removePrimaryPointer(inPointer) {
    ...
    processTouches(inEvent, inFunction) {
    ...
    cleanUpPointer(inPointer) {
      touch__pointermap.delete(inPointer.pointerId);
      this.removePrimaryPointer(inPointer);
    },

    // prevent synth mouse events from creating pointer events
    dedupSynthMouse(inEvent) {
